<section id="contact" class="py-20">
  <div class="container mx-auto px-6">
    ...
    <div class="max-w-2xl mx-auto backdrop-blur-md bg-white/30 rounded-2xl shadow-lg p-8">
      <div class="flex justify-center space-x-6 mb-8">
        <a href="https://github.com/mathiasferns" target="_blank" rel="noopener noreferrer" class="text-gray-800 hover:text-gray-900 transition">
        ...
        <a href="https://instagram.com/mathiasferns" target="_blank" rel="noopener noreferrer" class="text-gray-800 hover:text-gray-900 transition">
        ...
        <a href="https://twitter.com/mathiasferns" target="_blank" rel="noopener noreferrer" class="text-gray-800 hover:text-gray-900 transition">
      ...
      <p class="text-center text-gray-800">
        Feel free to reach out through any of my social media profiles above!
      </p>
    </div>
  </div>
</section>